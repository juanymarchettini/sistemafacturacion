...
class MYPDF extends TCPDF {
    ...
    public function Header() {
        ...
        // Title
        $this->Cell(60,9,'',0,1);
        $this->Cell(0, 0, 'LISTA DE PRECIOS DISTRIBUIDOR '.date('d-m-Y') , 0, 1, 'R', 0, '', 0, false, 'M', 'M');
...
// This method has several options, check the source code documentation for more information.
$pdf->Output('Distribuidor Overall'.'-'.date('d-m-Y').'.pdf', 'D');
